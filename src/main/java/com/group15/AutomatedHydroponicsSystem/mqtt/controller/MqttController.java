...
//    }
    ...
    @PostMapping("/reset-acidic-pump-count") // Call When the user refills the acidic solution
    public void resetAcidicPumpCount() {
        DataVariables.phLowPumpCount = 0;
    }

    @PostMapping("/reset-base-pump-count")  // Call When the user refills the base solution
    public void resetBasePumpCount() {
        DataVariables.phPumpCount = 0;
    }

    @PostMapping("/reset-tds-pump-count")  // Call When the user refills the tds solution
    public void resetTdsPumpCount() {
        DataVariables.tdsPumpCount = 0;
    }
